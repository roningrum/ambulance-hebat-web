            ...
            <div class="row g-5">
                <div class="col-md-8 pb-4 mb-4">
                    ...
                    <article class="blog-post mb-5">
                        <img src="{{ asset($blog->img_blog) }}" alt="">
                        <h2>
                        ...
                        <div class="post-meta mt-2">
                            <span class="d-block"><a href="/authors/{{$blog->author->username}}" class="text-decoration-none">{{$blog->author->name}}</a> in <a href="#" class="text-decoration-none">{{ $blog->category->name }}</a></span>
