                ...
                <div class="row g-3">
                    <div class="col-sm-5">
                        ...
                        <input type="text" class="form-control @error('name') is-invalid @enderror" id="name"
                            placeholder="Isi nama" required value={{ old('name') }}>
                        @error('name')
                    ...
                    <div class="col-sm-4">
                        ...
                        <input type="email" class="form-control @error('name') is-invalid @enderror" id="email"
                            placeholder="Isi Email"required value={{ old('email') }}>
                        @error('email')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                    ...
                    <div class="col-9">
                        ...
                        <input type="text" class="form-control @error('subjek') is-invalid @enderror"id="subjek"
                            placeholder="Isi Subjek" required value={{ old('subjek') }}>
                        @error('subjek')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                    ...
                    <div class="col-9">
                        ...
                        <textarea class="form-control" id="pesan" rows="3"
                            placeholder="Isi pesan berupa kritik, saran atau pertanyaan soal Ambulance Hebat"></textarea>
                        @error('message')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
