                ...
                <div class="col-md-8 pb-4 mb-4">
                    ...
                    <article class="blog-post mb-5">
                        ...
                        <div class="post-meta mt-2">
                            <span class="d-block"><a href="/authors/{{$blog->user->username}}" class="text-decoration-none">{{$blog->user->username}}</a> in <a href="/categories/{{$blog->category->name}}" class="text-decoration-none">{{ $blog->category->name }}</a></span>
