    ...
    <div class="container galery-title mt-5">
      ...
      <div class="row g-4">
        <div class="col-lg-6 col-md-6 col-sm-6">
          <img src="imgs/kegiatan-1.png"alt="" width="100%"srcset="">
        </div>
        <div class="col-lg-6 col-md-6 col-sm-4">
          <img src="imgs/kegiatan-2.png" alt="" width="100%" srcset="">
        </div>
        <div class="col-lg-6 col-md-6 col-sm-4">
          <img src="imgs/kegiatan-3.png" alt="" width="100%" srcset="">
        </div>
        <div class="col-lg-6 col-md-6 col-sm-4">
          <img src="imgs/kegiatan-4.png" alt="" width="100%" srcset="">
        </div>
      </div>
    </div>
    </div>
