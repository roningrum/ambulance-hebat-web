    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
            <ul class="navbar-nav">
                ...
                <li class="nav-item mx-3">
                    <a class="nav-link {{ ($title === "article") ? 'active' :''}}" aria-current="page" href="/artikel">Artikel</a>
                </li>
                <li class="nav-item mx-3">
                    <a class="nav-link {{ ($title === "tanya") ? 'active' :''}}" aria-current="page" href="/tanya">Tanya Kami</a>
                </li>
                <li class="nav-item mx-3">
                    <a class="nav-link {{ ($title === "contact") ? 'active' :''}}" aria-current="page" href="/contact-us">Kontak Kami</a>
                </li>
            </ul>
        </div>
    </div>
