...
<section id="hero"  class="py-5">
    <div class="container hero-tagline">
      <div class="row gx-5 align-items-center justify-content-center">
        <div class="col-lg-8 col-xl-6 col-xxl-6">
          <div class="my-5 text-center text-xl-start" data-aos="fade-up">
            <h1 class="text-white mb-4">
              Layanan Ambulance Hebat Andalan Masyarakat <br> Kota Semarang
            </h1>
        ...
        <div class="col-xl-6 col-xxl-6 d-none d-xl-block text-center" data-aos="fade-right">
          <img
            class="img-fluid rounded-3 my-5"
            src="imgs/ambulance.png"
            alt="..."
          />
        </div>
      </div>
    ...
    <section id="desc">
        <div class="container px-4 px-lg-4 my-4">
          <div class="row gx-4 gx-5 px-4 desc-info d-flex align-items-center justify-content-center">
            <div class=" col-lg-6 col-md-6">
              <img src="imgs/foto-aha1.png" width="100%" height="250px" class="img-fluid"alt="">
            </div>
            <div class="col-md-6">
              <h1>Ambulance Hebat SiCepat</h1>
              <p class="my-4">Layanan emergenci untuk penangan kasus kegawatdaruratan di Kota Semarang. Ambulan hebat adalah salah satu
                layanan gratis yang disediakan oleh Pemerintah Kota Semarang, dibawah asuhan Dinas Kesehatan Kota Semarang
              </p>
              <button class="button-more my-5">
                <a href="/about"></a>
                Selengkapnya</button>
            </div>
          </div>
