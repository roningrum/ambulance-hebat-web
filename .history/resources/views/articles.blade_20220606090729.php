            ...
            <div class="row g-5">
                <div class="col-md-8 pb-4 mb-4">
                    ...
                    <article class="blog-post mb-5">
                        ...
                        <p>{{ $blog->excerpt}}</p>
                        <a href="/baca/{{ $blog->slug }}"> Read More </a>
                        <div class="post-meta pt-4">
                            <span class="d-block"><a href="#" class="text-decoration-none">Admin</a> in <a href="#" class="text-decoration-none">{{ $blog->category->name }}</a></span>
