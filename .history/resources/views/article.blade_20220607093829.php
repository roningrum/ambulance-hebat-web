                ...
                <div class="col-lg-9 col-lg-offset-2 col-md-10 col-xs-12 mx-auto">
                    <article class="blog-post">
                        ...
                        <div class="d-flex mb-5">
                            ...
                            <div class="vcard">
                                <span class="d-block">
                                    <a href="/authors/{{$blog->user->username}}" class="text-decoration-none">{{ $posts->user->username }}</a> in <a href="/categories/{{ $posts->category->slug }}" class="text-decoration-none"> {{ $posts->category->name }}</a>
                                </span>
                                <span>
                                   January 2022 
                                </span>
