...
@section('content')
    ...
    <section id="form-contact">
        <div class="container">
            ...
            <p class="mb-2">Kami sangat mengapresiasi saran, kritik, terstimonial dan pertanyaan Anda</p>
            <p class="mb-2">Silahkan mengisi kolom di bawah ini untuk mengontak kami </p>
            <form class="needs-validation mt-4">
                <div class="row g-3">
                    <div class="col-sm-5">
                        <label for="firstName" class="form-label">Nama</label>
                        <input type="text" class="form-control" id="firstName" placeholder="Isi nama" value="" required="">
