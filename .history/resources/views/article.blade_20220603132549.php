            ...
            <div class="row mt-5">
                <div class="col-lg-9 col-lg-offset-2 col-md-10 col-xs-12 mx-auto">
                    <article class="blog-post">
                        ...
                        <p>  
                            <i class="fa-solid fa-user me-2"></i><a href="">Admin</a> Admin in <a href="/categories/{{ $posts->category->slug }}"> {{ $posts->category->name }}</a></p>
                        <img src= "{{ asset('imgs/'.$posts->img_blog) }}" class="img-fluid"alt="">
                        {!! $posts->body !!}
                        <p class="blog-post-meta">
                          {{-- <i class="fa-solid fa-user me-2"></i><a href="">{{ $posts["author"] }}</a> --}}
